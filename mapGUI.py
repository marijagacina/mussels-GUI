...
"""Global variables that are accessed by multiple classes and functions"""
mussels = {}
...
class InfoWidget(QWidget):
    ...
    def display_info(self):
        ...
        self.long.toggled.connect(lambda: self.plotting_widget(self.selected_mussel.time_array,
...
class TimeAxisItem(pg.AxisItem):
    ...
    def tickStrings(self, values, scale, spacing):
        return ['%d:%d:%d' % ((value % 86400) // 3600 + 2, (value % 3600) // 60, value % 60) for value in values]
